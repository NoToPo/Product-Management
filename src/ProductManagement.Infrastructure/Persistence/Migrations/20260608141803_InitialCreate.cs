        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_variant_reserved_within_stock", "reserved_quantity >= 0 AND reserved_quantity <= stock_quantity");
                    table.CheckConstraint("ck_variant_stock_non_negative", "stock_quantity >= 0");
                    table.ForeignKey(
